...
const PlaceOrder = () => {
      ...
      handler: async (response) => {
        ...
        try {
          ...
          if (data.success) {
            ...
            toast.error(data.message); // Log error message
          }
        } catch (error) {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
        ...
        for (const item in cartItems[items]) {
          if (cartItems[items][item].quantity > 0) {
            ...
            if (itemInfo) {
              ...
              // Include gift packaging details if selected
              if (cartItems[items][item].giftPackage) {
                itemInfo.giftPackage = {
                  ...cartItems[items][item].giftPackage,
                  quantity: cartItems[items][item].quantity,
                };
                console.log("Gift Package Selected:", itemInfo.giftPackage);
              }
      ...
      console.log("Order Data:", orderData); // Log the complete order data for backend verification
  ...
  return (
    ...
    >
      ...
      <div className="mt-8">
        ...
        <button
          type="submit"
          className="mt-8 bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-500 transition duration-200"
        >
          Place Order
        </button>
      </div>
